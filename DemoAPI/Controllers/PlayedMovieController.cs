...
namespace DemoAPI.Controllers
{
    ...
    [ApiController]
    public class PlayedMovieController : ControllerBase
    {
        private IPlayedmovieService _service;

        public PlayedMovieController(IPlayedmovieService PlayedmovieService) 
        {
