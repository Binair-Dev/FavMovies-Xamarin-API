...
namespace DemoAPI.Controllers
{
    ...
    [ApiController]
    public class ScenarisedMovieController : ControllerBase
    {
        private IScenarisedmovieService _service;

        public ScenarisedMovieController(IScenarisedmovieService PlayedmovieService) 
        {
